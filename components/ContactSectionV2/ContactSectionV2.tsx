...
export const ContactSectionV2 = ({
  ...
  return (
    <div className="-mt-0 pb-12 px-10 lg:px-28 flex gap-4 lg:gap-10 flex-col lg:flex-row z-10 w-5/6 ">
      {/* Vista Mobile */}
      ...
      {/* Vista Desktop */}
      <div className="w-full px-8 lg:px-20 py-8 lg:py-24 rounded-3xl bg-white -mt-36">
