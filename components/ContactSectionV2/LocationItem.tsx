...
export const LocationItem = ({ location_title, location_text }) => {
  return (
    <div className="flex flex-row gap-4">
      ...
      <div className="flex flex-col gap-1">
        <p className="text-black font-bold">{location_title}</p>
        <p className="text-gray-500 text-sm">{location_text}</p>
      </div>
    </div>
  );
};
