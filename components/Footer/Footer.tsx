...
export const Footer = ({ component }: FooterContent) => {
  ...
  return (
    <div className="bg-ov-primaryLight h-112 w-full flex justify-between py-16">
          ...
          {component?.phone_text_1 || component?.phone_text_2 ? (
            <div className="flex flex-row gap-2 items-start">
              ...
              <div className="flex flex-col items-start">
                {component?.phone_text_1 ? (<p className="text-white">{component.phone_text_1}</p>) : null}
                {component?.phone_text_2 ? (<p className="text-white">{component.phone_text_2}</p>) : null}
              </div>
            </div>
          ) : null}
        </div>
